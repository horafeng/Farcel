...
| `BouncingBall-fmi2.fmu` | 2.0 | Co-Simulation + Model Exchange | 官方 FMI2 ME root/state-event、bounce、CVode reset 与继续推进回归 | 官方 v0.0.41 `Reference-FMUs.zip` 的 `2.0/BouncingBall.fmu`；SHA-256 `3959D0DEA751E788B7B9591DA6BEB11955352A1AC46138244EE5343EFB7CE5E4` | BSD-2-Clause；见 `Reference-FMUs-LICENSE.txt` |
| `Feedthrough-fmi2.fmu` | 2.0 | Co-Simulation + Model Exchange | 官方 FMI2 ME 零连续状态、continuous input event 与 output 回归 | 官方 v0.0.41 `Reference-FMUs.zip` 的 `2.0/Feedthrough.fmu`；SHA-256 `2D4AC516803691BE0BB69E92A85D5BA70ABAB795323903BBB3E719AF6964DDAD` | BSD-2-Clause；见 `Reference-FMUs-LICENSE.txt` |
