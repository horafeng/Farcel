/* Farcel Standard Block Library -- Sum FMI 2.0 Co-Simulation FMU. SPDX-License-Identifier: MIT */
#include <stddef.h>
#include <stdlib.h>
...
typedef struct { fmi2Real u1; fmi2Real u2; } SumInstance;
...
FMI2_EXPORT fmi2Component fmi2Instantiate(fmi2String name, fmi2Type type, fmi2String guid, fmi2String resource, const fmi2CallbackFunctions* callbacks, fmi2Boolean visible, fmi2Boolean logging) {
    ...
    return type == fmi2CoSimulation ? calloc(1, sizeof(SumInstance)) : NULL;
}
...
FMI2_EXPORT fmi2Status fmi2Reset(fmi2Component c) { if (c == NULL) return fmi2Error; ((SumInstance*)c)->u1 = 0.0; ((SumInstance*)c)->u2 = 0.0; return fmi2OK; }
FMI2_EXPORT fmi2Status fmi2SetReal(fmi2Component c, const fmi2ValueReference refs[], size_t n, const fmi2Real values[]) {
    SumInstance* instance = (SumInstance*)c; size_t i;
